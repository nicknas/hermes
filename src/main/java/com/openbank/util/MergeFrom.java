...
/**
 * An example of a class used to create test data from JSON templates using
 * Freemarker.
 */
public class MergeFrom {
    ...
    public MergeFrom withVarsFrom(Map<String, String> vars) {
        this.vars = vars;
        return this;
    }

	public String withFieldsFrom(Map<String, String> fieldValues) {
		Map<String, String> fieldDictionary = new HashMap<>(vars);
		if (fieldValues != null)
